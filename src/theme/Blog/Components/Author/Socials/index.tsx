...
import BFBAN from '@site/src/theme/Icon/Socials/BFBAN';
import BiliBili from '@site/src/theme/Icon/Socials/BiliBili';
...
declare module '@site/src/theme/Icon/Socials/BFBAN' {
  export interface Props extends ComponentProps<'svg'> {}

  export default function BFBAN(props: Props): ReactNode;
}

declare module '@site/src/theme/Icon/Socials/BiliBili' {
  export interface Props extends ComponentProps<'svg'> {}

  export default function BiliBili(props: Props): ReactNode;
}
