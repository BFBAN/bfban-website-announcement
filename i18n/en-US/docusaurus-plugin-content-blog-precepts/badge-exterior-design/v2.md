...
Here's an example of using svg https://github.com/BFBAN/exterior-design/blob/main/Example/use-icon-web.html ,to implement the Diablo Tour mode.
...
<div class=“px-4 py-5 mb-1 text-center border rounded-3”>
